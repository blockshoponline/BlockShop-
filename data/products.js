...
const PRODUCTS = [
  ...
  // ── PRODUTO 1 — Anel Smart DAIPAN ──
  {id:1,brand:'DAIPAN',name:'Anel Smart Inteligente DAIPAN',
   img:'images/products/anel-smart-daipan.jpg',
   emoji:'💍',price:4998,oldPrice:6400,discount:22,rating:4.8,reviews:312,stock:40,badge:'hot',
   ...
   desc:'O Anel Smart Inteligente DAIPAN combina tecnologia e estilo em um acessório unissex sofisticado. Monitora sua temperatura corporal em tempo real, registra atividade física e notifica mensagens diretamente no anel. Feito em aço inoxidável premium com display digital embutido — ideal para uso diário, treinos e ocasiões especiais.',
   specs:[['Marca','DAIPAN'],['Modelo','R007'],['Material','Aço inoxidável premium'],['Largura','8 mm'],['Funções','Temperatura, fitness, notificações'],['Display','Digital com leitura de temperatura'],['Gênero','Unissex'],['Ocasião','Uso diário, esportes, casamento'],['Compatível','Universal']]},

  // ── PRODUTO 2 — iPhone 16 Pro Max ──
  {id:2,brand:'Apple',name:'iPhone 16 Pro Max 256GB',
  ...
  // ── PRODUTO 3 — Galaxy S25 Ultra ──
  {id:3,brand:'Samsung',name:'Galaxy S25 Ultra 512GB',
  ...
  // ── PRODUTO 4 — Sony WH-1000XM6 ──
  {id:4,brand:'Sony',name:'WH-1000XM6 Headphone',
  ...
  // ── PRODUTO 5 — MacBook Air M3 ──
  {id:5,brand:'Apple',name:'MacBook Air M3 15"',
  ...
  // ── PRODUTO 6 — Razer BlackShark V2 Pro ──
  {id:6,brand:'Razer',name:'BlackShark V2 Pro',
  ...
  // ── PRODUTO 7 — Apple Watch Series 10 ──
  {id:7,brand:'Apple',name:'Watch Series 10 GPS 46mm',
  ...
  // ── PRODUTO 8 — Galaxy Tab S10 Ultra ──
  {id:8,brand:'Samsung',name:'Galaxy Tab S10 Ultra',
  ...
  // ── PRODUTO 9 — JBL Flip 7 ──
  {id:9,brand:'JBL',name:'Flip 7 Caixa Bluetooth',
  ...
  // Troque o id: pelo próximo número (10, 11, 12...)
...
const REVIEWS=[
  ...
  {name:'Mateus R.',av:'👨‍💻',text:'Recebi em 1 dia útil, produto original com nota fiscal. Terceira compra na Block Shop — sempre excelente!',stars:'★★★★★',date:'há 5 dias',prod:'iPhone 16 Pro Max'},
  {name:'Camila S.',av:'👩‍🎤',text:'Fone chegou bem embalado, qualidade incrível. A verificação blockchain me deu muita segurança na compra!',stars:'★★★★★',date:'há 1 semana',prod:'Sony WH-1000XM6'},
  {name:'Bruno T.',av:'👨‍🚀',text:'MacBook chegou lacrado, produto idêntico à loja oficial da Apple. Preço muito melhor. Recomendo demais!',stars:'★★★★★',date:'há 1 semana',prod:'MacBook Air M3'},
  {name:'Rafael M.',av:'🧑',text:'Preço imbatível. Chegou no prazo, nota fiscal em dia. Muito satisfeito com a Block Shop!',stars:'★★★★★',date:'há 2 semanas',prod:'Apple Watch S10'},
];

const TICKERS=[
  '🟢 Lucas de São Paulo comprou Anel Smart DAIPAN Preto há 2 min',
  '🟢 Fernanda do Rio comprou Anel Smart DAIPAN Dourado há 5 min',
  '🟢 Marcos de BH comprou iPhone 16 Pro Max há 8 min',
  '🟢 Patrícia de Curitiba comprou Anel Smart DAIPAN Prata há 11 min',
  '🟢 João de Fortaleza comprou Apple Watch S10 há 14 min',
  '🟢 Aline de Porto Alegre comprou MacBook Air M3 há 18 min',
  '🔴 Apenas 40 unidades do Anel Smart DAIPAN disponíveis!',
  '⚡ Flash Sale ativo — Anel Smart com 22% OFF hoje!',
